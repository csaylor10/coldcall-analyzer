...
Overall Performance: X/10Rep Name: [Name or "Unknown"]Call Categorization: [Voicemail | Estimate not given | Gave estimate and rejected | Gave estimate and set a follow-up | Gave estimate and sold]Main Objection: [Customer's exact words or "None"]Red Flags: [Yes or No]Reason for Red Flag: [Briefly state reason or "None"]Red Flag Direct Quotes: ["Exact quote(s)" or "None"]
...
Criteria: Handling common objections and providing relevant information to alleviate customer concerns, such as:

"I want to stick with my current service."

"I want to continue doing it myself."
...
Buying Signals:Direct quotes indicating interest:Missed buying signals:
...
async def upload_audio(file: UploadFile = File(...)):
    ...
    # Save analysis + transcript explicitly
